...
if (((!$hipoul_settings['alt_home_footerwidget'] || !is_front_page()) && is_active_sidebar('footer-widget-area')) 
	|| ($hipoul_settings['alt_home_footerwidget'] && is_active_sidebar('home-footer-widget-area') && is_front_page())) : ?>
    ...
    <div id="sidebar_bottom" class="sidebar clearfix">
		...
		<?php if (is_front_page() && $hipoul_settings['alt_home_footerwidget']) : ?>
