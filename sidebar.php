...
<div id="sidebar1">
	...
	} elseif ( is_front_page() && !$hipoul_settings['alt_home_sidebar'] && is_active_sidebar( 'sidebar-widget-area' ) ) { // Home, but alternate sidebar disabled, display normal sidebar if active
		dynamic_sidebar('sidebar-widget-area');
	} elseif ( is_front_page() && $hipoul_settings['alt_home_sidebar'] && is_active_sidebar( 'home-sidebar-widget-area' ) ) { // Home, alternate sidebar enabled, display alternate sidebar if active
