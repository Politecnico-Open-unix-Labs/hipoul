    ...
    <div class="postbox">
        ...
        <div class="panel-wrap inside">
            <table class="form-table">
                <tr>
                    <td>
                        <input type="checkbox" name="graphene_settings[enable_preview]" id="enable_preview" <?php checked( $hipoul_settings['enable_preview'] ); ?> value="true" />
            ...
            <ul class="graphene-action-hooks">    
                ...
                ?>
                    <li>
                        ...
                        <ul class="hooks-list">
                            <li class="widget-hooks<?php if(count(array_intersect( $actionhook['hooks'], $hipoul_settings['widget_hooks'] ) ) == 0) echo ' hide'; ?>">
                    <?php foreach ( $actionhook['hooks'] as $hook) : ?>
                                <input type="checkbox" name="graphene_settings[widget_hooks][]" value="<?php echo $hook; ?>" id="hook_<?php echo $hook; ?>" <?php if ( in_array( $hook, $hipoul_settings['widget_hooks'] ) ) echo 'checked="checked"'; ?> /> <label for="hook_<?php echo $hook; ?>"><?php echo $hook; ?></label><br />
                    <?php endforeach; ?>
                            </li>
                        </ul>
                    </li>
