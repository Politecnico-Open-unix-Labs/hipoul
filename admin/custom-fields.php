...
function graphene_save_custom_meta( $post_id ){
	...
	*/
	...
	if ( 'post' == $_POST['post_type'] ) {
		update_post_meta( $post_id, '_hipoul_post_date_display', $_POST['hipoul_post_date_display'] );
	}
...
function graphene_custom_meta( $post){ 
	...
	if ( 'post' == $post->post_type ){
		$post_date_display = ( get_post_meta( $post->ID, '_hipoul_post_date_display', true ) ) ? get_post_meta( $post->ID, '_hipoul_post_date_display', true ) : '';
	}
    ...
    <table class="form-table">
        ...
        <tr>
            <th scope="row">
                <label for="hipoul_post_date_display"><?php _e( 'Post date display', 'graphene' ); ?></label>
            </th>
            <td>
                <select id="hipoul_post_date_display" name="hipoul_post_date_display">
